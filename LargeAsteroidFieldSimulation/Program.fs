...
namespace global
  module LargeAsteroidFieldSimulation =
    ...
    (*
    We will reuse the Asteroid definition, the Vector2 definition, even the simulation and asteroid field initialization functions from the previous chapters.
    ...
    *)
    ...
    open SmallAsteroidFieldSimulation
    open Math
    open QuadTree
